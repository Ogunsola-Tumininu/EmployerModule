        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var emp = db.EmployerDetails.Where(e => e.Recno == model.UserName).FirstOrDefault(); 
                    emp.ContactPerson = model.ContactPerson;
                    emp.Email = model.Email;
                    emp.MobilePhone = model.PhoneNo;
                    ...
                    await this.UserManager.AddToRoleAsync(user.Id, "EmpAdmin");
